...
from My_Trainer_1_Final import test_loader
import time
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("E://VS Testing LEVIR dataset ONLY//test_6-3-2025_CGNet - 2//checkpoints_FullLevir//checkpoint1-BCE-50epochs//ResUnet14.pth"), strict=False)
    model.eval()
    test_results_path="E://VS Testing LEVIR dataset ONLY//test_6-3-2025_CGNet - 2//test results_Levir//test_results3"
    ...
    with torch.no_grad():
        for _, data in enumerate(test_loader):
            ...
            prediction = torch.where(probs> 0.4602145254611969, 1.0,0.0)
