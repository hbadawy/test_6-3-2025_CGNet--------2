...
model1.load_state_dict(torch.load("E://VS Testing LEVIR dataset ONLY//test_6-3-2025_CGNet - 2//checkpoints_FullLevir//checkpoint1-BCE-50epochs//ResUnet14.pth"), strict=False)
model1.eval()
